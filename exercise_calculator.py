def calculator():
    ...
    if cuenta == "+": print (f"Resultado: {num_1 + num_2}")
    elif cuenta == "-": print (f"Resultado: {num_1 - num_2}")
    elif cuenta == "*": print (f"Resultado: {num_1 * num_2}")
    elif cuenta == "/" and num_2 != 0 : print (f"Resultado: {num_1 / num_2}")
    elif cuenta == "/" and num_2 == 0: print ("Error: division por cero")
